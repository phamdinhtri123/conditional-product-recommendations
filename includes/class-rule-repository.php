...
class CRW_Rule_Repository {
	...
	private function sanitize_display_settings( array $settings ) {
		...
		return array(
			...
			'product_layout_mode'      => $this->sanitize_choice( $settings['product_layout_mode'], array( 'columns', 'rows' ), $legacy_layout_mode ),
			...
			'cart_layout_mode'         => $this->sanitize_choice( $settings['cart_layout_mode'], array( 'columns', 'rows' ), $legacy_layout_mode ),
			...
			'checkout_layout_mode'     => $this->sanitize_choice( $settings['checkout_layout_mode'], array( 'columns', 'rows' ), $defaults['checkout_layout_mode'] ),
